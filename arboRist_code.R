...
# main options
base_dir <- "path.expand('~/Desktop/')" # change to whereever you want your project directory stored
project_name <- "EMT_data_pull" # name your project


taxa_file <- read.csv("/Users/scott/Desktop/EMT_data_pull/Checklist_taxa.csv", header = TRUE)
taxa_of_interest <- taxa_file[,1]
